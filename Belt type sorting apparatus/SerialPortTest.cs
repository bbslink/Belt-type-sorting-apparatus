...
namespace GroupDemo
{
    public partial class frmSerialPort : Form
    {
        ...
        /// 默认串口对象
        /// </summary>
        private static frmSerialPort minserialPort;

        /// <summary>
        /// 获取默认串口对象
        /// </summary>
        public static frmSerialPort GetSerialPort()
        {
            if (minserialPort == null)
            {
                minserialPort = new frmSerialPort();
            }
            return minserialPort;
        }

        /// <summary>
        /// 发送指令（接口）  指令格式如; "01108050000204FFFFFFFF"
        /// </summary>
        public bool sendMes(string info)
        {
            try
            {
                byte[] sendData = null;
                sendData = strToHexByte(info.Trim());
        ...
        public bool openSerial(string comNum)
        {
            ...
            if (ComDevice.IsOpen == false)
            {
                ...
                ComDevice.Parity = (Parity)Convert.ToInt32("None");
                ...
                {
                    MessageBox.Show(ex.Message, "串口通讯错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return false;
                }
        ...
        {
            string ssr = CRC.ToModbusCRC16(txtSendData.Text.Trim());
            ...
            {
                sendData = strToHexByte(txtSendData.Text.Trim()+ ssr);
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           string ss= CRC.ToModbusCRC16(textBox1.Text.Trim());
